...
--
-- Host: 127.0.0.1:3307
-- Tempo de geração: 09/06/2026 às 02:23
...
CREATE TABLE `atendimentos` (
  ...
  `status` enum('Aberto','Em Andamento','Concluido','Cancelado') DEFAULT NULL,
...
(1, 'Administrador', 'admin@atendelab.com', '$2y$10$J9P2kU2BAMZ3TZcuxTsW4e1D/lka8EocYHzvyoOZmCNcWDQz3RuVC', 'admin', 'ativo', '2026-06-04 21:14:55');
